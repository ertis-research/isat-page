    ...
    content:
      ...
      steps:
        ...
        - icon: "globe"
          ...
          description: "WiFi, GPRS/4G, comunicación analógica y digital (Modbus-RTU) para máxima interoperabilidad con sensores y redes existentes"
        - icon: "satellite-dish"
          title: "Transmisión Multi-Protocolo"
          description: "Comunicación GPRS/4G, WiFi y satélite para garantizar conectividad en entornos remotos"
        - icon: "circle-nodes"
